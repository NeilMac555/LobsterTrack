...
<p><a href="https://www.steamwatch.io">Back to SteamWatch</a></p>`,
  },
  {
    ...
    description:
      'What blindly backing every favourite, underdog or draw at Pinnacle closing prices returned across 8,666 top-five-league matches since 2021/22, by odds band, league, season and venue, plus every Premier League, La Liga and Serie A club on its own. Favourites dead level, underdogs -10.7%.',
    ogType: 'website',
    jsonLd: [
      {
        '@context': 'https://schema.org',
