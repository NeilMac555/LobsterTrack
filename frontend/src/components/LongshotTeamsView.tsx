      ...
      {locked && (
        <div className="mb-6">
          <PaywallOverlay
            ...
            description="Premier League 25/26 and 26/27 are free per team — SteamWatch Pro opens La Liga, Serie A and the Bundesliga, every season back to 2021/22 and the all-time view, for every club."
          />
        </div>
      )}
